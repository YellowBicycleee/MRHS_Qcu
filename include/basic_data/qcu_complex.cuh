...
class Complex {
 ...
 public:
  ...
  __device__ __host__ __forceinline__ _Float norm2() const { return sqrt(real_ * real_ + imag_ * imag_); }
  __device__ __host__ __forceinline__ _Float norm2Square() const { return real_ * real_ + imag_ * imag_; }
